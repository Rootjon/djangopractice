! function (t, n) {
    "object" == typeof exports && "object" == typeof module ? module.exports = n() : "function" == typeof define && define.amd ? define([], n) : "object" == typeof exports ? exports.HSShowAnimation = n() : t.HSShowAnimation = n()
}(window, function () {
    return (d = {
        "./src/js/hs-show-animation.js": function (module, exports, __webpack_require__) {
            "use strict";
    ...
    }, e = {}, f.m = d, f.c = e, f.d = function (t, n, e) {
        ...
        if (f.r(e), Object.defineProperty(e, "default", {
            ...
            for (var o in n) f.d(e, o, function (t) {
                return n[t]
            }.bind(null, o));
        return e
    }, f.n = function (t) {
    ...
    }, f.p = "", f(f.s = "./src/js/hs-show-animation.js")).default;
