! function (t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.HSStepForm = e() : t.HSStepForm = e()
}(window, function () {
    return (d = {
        "./src/js/hs-step-form.js": function (module, exports, __webpack_require__) {
            "use strict";
        ...
        if (f.r(n), Object.defineProperty(n, "default", {
            ...
            for (var s in e) f.d(n, s, function (t) {
                return e[t]
            }.bind(null, s));
        return n
    }, f.n = function (t) {
    ...
    }, f.p = "", f(f.s = "./src/js/hs-step-form.js")).default;
